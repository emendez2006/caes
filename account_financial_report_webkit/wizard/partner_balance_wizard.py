...
class AccountPartnerBalanceWizard(orm.TransientModel):
    ...
    _columns = {
        ...
        'event_ids': fields.many2many('event.event', 
                                      'event_report_partner_balance_rel', 
                                      'partner_balance_id', 
                                      'event_id', string="Filters on Events"),
    }
    ...
    def pre_print_report(self, cr, uid, ids, data, context=None):
        ...
        vals = self.read(cr, uid, ids,
                         ['result_selection', 'partner_ids', 'event_ids'],
                         context=context)[0]
    ...
    def _print_report(self, cursor, uid, ids, data, context=None):
        ...
        if data['form']['result_selection'] == 'customer':
            ...
            return {'type': 'ir.actions.report.xml',
                'report_name': 'account.account_report_partner_balance_without_event_webkit',
                'datas': data}
